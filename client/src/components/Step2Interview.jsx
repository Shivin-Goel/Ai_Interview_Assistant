/* Mount -> Load Voice -> Intro Speak -> Question Speak -> Mic On -> Timer Running -> 
            ...
            <div className='w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
                ...
                <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
                    <div className='w-full max-w-md rounded-2xl overflow-hidden shadow-xl'>
                        <video src={videoSource} key={videoSource} ref={videoRef} loop muted playsInline preload="auto"
                    ...
                    {/*subtitle*/}
                    {
                        subtitle && (
                            <div className='w-full max-w-md bg-gray-50 border border-gray-200 rounded-xl p-4 shadow-sm'>
                                <p className='text-gray-700 text-sm sm:tect-base font-medium text-center leading-relaxed'>
                                    {subtitle}
                                </p>
                            </div>
                        )
                    ...
                    <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl p-6 shadow-md space-y-5'>
                        ...
                        <div className='grid grid-cols-2 gap-6 text-center'>
                            <div>
                                ...
                                <span className='text-sm text-gray-500'>Current Question</span>
                            </div>
