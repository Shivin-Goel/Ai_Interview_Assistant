      ...
      <div className="flex-1 px-6 py-20">
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-s px-4 py-2 rounded-full flex item-center gap-2'>
          ...
          <div className='text-center mb-28'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-mid'>
                Start Interview
              </motion.button>
              ...
              [
                {
                  ...
                  desc: "AI adjusts difficuly based on job role. "
                },
                {
                  icon: <BsMic size={24} />,
                  step: "Step 2",
          ...
          <div className='mb-2'>
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className='text-4xl font-semibold text-center mb-16'>Advanced AI {" "} <span className='text-green-500'>Capabilities</span></motion.h2>
                ...
                [
                  {
                    ...
                    desc: "Scores communication, technical accuray and confidence."
                  },
                  {
                    image: resumeImg,
                  ...
                  },
                  {
                    ...
                    desc: "Get detailed performance analytics and AI feedback in a professional PDF report."
                  },
                  {
                    image: analyticsImg,
                    icon: <BsBarChart size={20} />,
          ...
          <div className='mb-2'>
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className='text-4xl font-semibold text-center mb-16'>Multiple Interview {" "} <span className='text-green-500'>Modes</span></motion.h2>
                ...
                [
                  {
                    ...
                    desc: "Behavioral questions & communication based evaluation."
                  },
                  {
                    image: techImg,
                    title: "Technical Interview Mode",
                    desc: "Deep technical questions based on uploaded resume."
                  },
                  {
                    image: confidenceImg,
